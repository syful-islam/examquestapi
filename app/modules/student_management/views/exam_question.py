...
from app.modules.student_management.models import ExamQuestion
from app.modules.student_management.serializers.serializer import ExamQuestionSerializer
