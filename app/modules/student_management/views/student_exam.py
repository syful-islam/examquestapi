...
from app.modules.student_management.serializers.student_exam import StudentExamSerializer

class StudentExamViewSet(AutoSetSubscriberMixin,viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        ...
        return StudentExamSerializer  # For POST/PUT requests
