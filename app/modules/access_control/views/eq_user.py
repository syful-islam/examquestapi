...
from ....models import EQUser
from ..serializers.eq_user import EQUserSerializer, EQUserNestedSerializer
from app.modules.auth.services.auth_service import AuthService
from app.core.mixins import AutoSetSubscriberMixin
from app.core.logger import log

class EQUserViewSet(AutoSetSubscriberMixin,viewsets.ModelViewSet):
    queryset = EQUser.objects.all()
    serializer_class = EQUserSerializer

    def get_serializer_class(self):
        if self.action in ['list', 'retrieve']:  # For GET requests
            return EQUserNestedSerializer
        return EQUserSerializer  # For POST/PUT requests
