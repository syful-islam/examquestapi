...
class EQUserSerializer(BaseModelSerializer,serializers.ModelSerializer):
    class Meta:
        model = EQUser
    ...
    def create(self, validated_data):
        ...
        user = EQUser.objects.create_user(**validated_data, password=password)
        return user
...
class EQUserNestedSerializer(BaseModelSerializer,serializers.ModelSerializer):
